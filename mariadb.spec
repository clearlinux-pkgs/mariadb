...
Version  : 10.4.20
Release  : 85
URL      : https://ftp.osuosl.org/pub/mariadb/mariadb-10.4.20/source/mariadb-10.4.20.tar.gz
Source0  : https://ftp.osuosl.org/pub/mariadb/mariadb-10.4.20/source/mariadb-10.4.20.tar.gz
Source1  : mariadb-install-db.service
Source2  : mariadb.service
Source3  : mariadb.tmpfiles
Source4  : https://ftp.osuosl.org/pub/mariadb/mariadb-10.4.20/source/mariadb-10.4.20.tar.gz.asc
...
%prep
%setup -q -n mariadb-10.4.20
cd %{_builddir}/mariadb-10.4.20
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626391137
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/mariadb-10.4.20/COPYING %{buildroot}/usr/share/package-licenses/mariadb/793d3cf202835b7b1584a2106d4292656d88e1ae
cp %{_builddir}/mariadb-10.4.20/extra/readline/COPYING %{buildroot}/usr/share/package-licenses/mariadb/4231152540c27f86b02f96e73605e1ff18d2ee95
cp %{_builddir}/mariadb-10.4.20/extra/wolfssl/wolfssl/COPYING %{buildroot}/usr/share/package-licenses/mariadb/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/mariadb-10.4.20/libmariadb/COPYING.LIB %{buildroot}/usr/share/package-licenses/mariadb/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/mariadb-10.4.20/libmariadb/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/mariadb/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/mariadb-10.4.20/pcre/LICENCE %{buildroot}/usr/share/package-licenses/mariadb/11ff082389982b8168263850db69199065f2028d
cp %{_builddir}/mariadb-10.4.20/pcre/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/mariadb/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/mariadb-10.4.20/plugin/handler_socket/handlersocket/COPYRIGHT.txt %{buildroot}/usr/share/package-licenses/mariadb/3914c2c16582bb3e404a22557a1f6b3c73db23a8
cp %{_builddir}/mariadb-10.4.20/plugin/handler_socket/libhsclient/COPYRIGHT.txt %{buildroot}/usr/share/package-licenses/mariadb/3914c2c16582bb3e404a22557a1f6b3c73db23a8
cp %{_builddir}/mariadb-10.4.20/plugin/handler_socket/perl-Net-HandlerSocket/COPYRIGHT.txt %{buildroot}/usr/share/package-licenses/mariadb/3914c2c16582bb3e404a22557a1f6b3c73db23a8
cp %{_builddir}/mariadb-10.4.20/plugin/server_audit/COPYING %{buildroot}/usr/share/package-licenses/mariadb/793d3cf202835b7b1584a2106d4292656d88e1ae
cp %{_builddir}/mariadb-10.4.20/storage/innobase/COPYING.Google %{buildroot}/usr/share/package-licenses/mariadb/21c6e1c3c9ef7e68ec6cf63b3efda490e81ba26a
cp %{_builddir}/mariadb-10.4.20/storage/innobase/COPYING.Percona %{buildroot}/usr/share/package-licenses/mariadb/8065fd50693d562d8f14d53ca84db13df5280c47
cp %{_builddir}/mariadb-10.4.20/storage/mroonga/COPYING %{buildroot}/usr/share/package-licenses/mariadb/d4c4fe8d1effe5471779e799caaa09cbb54e5b3f
cp %{_builddir}/mariadb-10.4.20/storage/mroonga/vendor/groonga/COPYING %{buildroot}/usr/share/package-licenses/mariadb/5db84f12bde6c5e77125936e1470be0f400ece5f
cp %{_builddir}/mariadb-10.4.20/storage/mroonga/vendor/groonga/vendor/plugins/groonga-normalizer-mysql/packages/debian/copyright %{buildroot}/usr/share/package-licenses/mariadb/60d021148ab131e6640e0edd7801f12f02a384e1
cp %{_builddir}/mariadb-10.4.20/storage/rocksdb/rocksdb/COPYING %{buildroot}/usr/share/package-licenses/mariadb/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/mariadb-10.4.20/storage/rocksdb/rocksdb/LICENSE.Apache %{buildroot}/usr/share/package-licenses/mariadb/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/mariadb-10.4.20/storage/rocksdb/rocksdb/LICENSE.leveldb %{buildroot}/usr/share/package-licenses/mariadb/59f297dcc2fbc8f9f3a966fd5290d72837fd6455
cp %{_builddir}/mariadb-10.4.20/storage/rocksdb/rocksdb/docs/LICENSE-DOCUMENTATION %{buildroot}/usr/share/package-licenses/mariadb/420cc096d9ce8dfabee4082196acb0383377f202
cp %{_builddir}/mariadb-10.4.20/storage/tokudb/PerconaFT/COPYING.AGPLv3 %{buildroot}/usr/share/package-licenses/mariadb/78e50e186b04c8fe1defaa098f1c192181b3d837
cp %{_builddir}/mariadb-10.4.20/storage/tokudb/PerconaFT/COPYING.APACHEv2 %{buildroot}/usr/share/package-licenses/mariadb/77c56994eb0a7752cf9b508dc4682ddce91828bf
cp %{_builddir}/mariadb-10.4.20/storage/tokudb/PerconaFT/COPYING.GPLv2 %{buildroot}/usr/share/package-licenses/mariadb/793d3cf202835b7b1584a2106d4292656d88e1ae
cp %{_builddir}/mariadb-10.4.20/storage/tokudb/PerconaFT/third_party/snappy-1.1.2/COPYING %{buildroot}/usr/share/package-licenses/mariadb/e1bc53918267ae9884c8da7c6d02865fe7c90d94
cp %{_builddir}/mariadb-10.4.20/storage/tokudb/PerconaFT/third_party/xz-4.999.9beta/COPYING %{buildroot}/usr/share/package-licenses/mariadb/c2caebe256c984f8484ae3e776200bfc17d35dda
cp %{_builddir}/mariadb-10.4.20/storage/tokudb/PerconaFT/third_party/xz-4.999.9beta/COPYING.GPLv2 %{buildroot}/usr/share/package-licenses/mariadb/793d3cf202835b7b1584a2106d4292656d88e1ae
cp %{_builddir}/mariadb-10.4.20/storage/tokudb/PerconaFT/third_party/xz-4.999.9beta/COPYING.GPLv3 %{buildroot}/usr/share/package-licenses/mariadb/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/mariadb-10.4.20/storage/tokudb/PerconaFT/third_party/xz-4.999.9beta/COPYING.LGPLv2.1 %{buildroot}/usr/share/package-licenses/mariadb/c0422cb05a3a12e1ff514bbd9c5fd4882c48d378
cp %{_builddir}/mariadb-10.4.20/vio/docs/COPYING.openssl %{buildroot}/usr/share/package-licenses/mariadb/7907ce0c0a371f3efe022b224eeebf5898f2bf8c
cp %{_builddir}/mariadb-10.4.20/win/packaging/COPYING.rtf %{buildroot}/usr/share/package-licenses/mariadb/ebebbb6bb4a431d7099e28f3fd1817a2bfdb1f72
cp %{_builddir}/mariadb-10.4.20/wsrep-lib/COPYING %{buildroot}/usr/share/package-licenses/mariadb/47aad6f6cae3514cdd9b80bb32587bf81d3b1fc0
cp %{_builddir}/mariadb-10.4.20/wsrep-lib/LICENSE %{buildroot}/usr/share/package-licenses/mariadb/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/mariadb-10.4.20/wsrep-lib/wsrep-API/v26/COPYING %{buildroot}/usr/share/package-licenses/mariadb/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build-avx2
%make_install_avx2  || :
popd
pushd clr-build
